...
# Use a random representative 20% sample from the corpus
set.seed(3202016)

texts[[1]][[1]] <- texts[[1]][[1]][as.logical(rbinom(n = line_count[1], size = 1, prob = .20))]
texts[[2]][[1]] <- texts[[2]][[1]][as.logical(rbinom(n = line_count[2], size = 1, prob = .20))]
texts[[3]][[1]] <- texts[[3]][[1]][as.logical(rbinom(n = line_count[3], size = 1, prob = .20))]
