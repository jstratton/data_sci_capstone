...
blog_monograms_table <- cbind(1:10, rownames(freq_1[[1]][1:10]), freq_1[[1]][1:10])

news_monograms_table <- cbind(1:10, rownames(freq_1[[2]][1:10]), freq_1[[2]][1:10])

twit_monograms_table <- cbind(1:10, rownames(freq_1[[3]][1:10]), freq_1[[3]][1:10])
...
blog_ngrams_table <- cbind(1:10, rownames(n_gram_freq_1[[1]][1:10]), n_gram_freq_1[[1]][1:10])

news_ngrams_table <- cbind(1:10, rownames(n_gram_freq_1[[2]][1:10]), n_gram_freq_1[[2]][1:10])

twit_ngrams_table <- cbind(1:10, rownames(n_gram_freq_1[[3]][1:10]), n_gram_freq_1[[3]][1:10])

rownames(blog_ngrams_table) <- rep(x = "", times = 10)
blog_ngrams_table

rownames(news_ngrams_table) <- rep(x = "", times = 10)
news_ngrams_table

rownames(twit_ngrams_table) <- rep(x = "", times = 10)
twit_ngrams_table
...
Heaps_1 <- Heaps_plot(x = tdm_1, lwd = 5, lty = 3, col = "blue", main = "Heaps Plot", xlab = "log(total no. of terms in texts)", ylab = "log(vocabulary size)")
